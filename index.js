...
var _gaugeAnimated = require('gauge-animated');

var _gaugeAnimated2 = _interopRequireDefault(_gaugeAnimated);
...
var ReactGauge = function (_React$Component) {
  ...
  function ReactGauge() {
    ...
    return _possibleConstructorReturn(this, (ReactGauge.__proto__ || Object.getPrototypeOf(ReactGauge)).apply(this, arguments));
  }
